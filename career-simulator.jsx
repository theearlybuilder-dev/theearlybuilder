      ...
      <Card T={T} style={{ padding: 26 }}>
        ...
        {mode === "signup" && (
          <>
            ...
            <Input T={T} value={name} onChange={setName} placeholder="Alex Rivera" />
            <div style={{ height: 14 }} />
        ...
        <div style={{ marginTop: 14, textAlign: "center", fontSize: 12, color: T.sub }}>
          No password needed for the demo. Your data is stored securely and only visible to you.
        </div>
      </Card>
    </div>
  );
